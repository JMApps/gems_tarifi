class AppStrings {
  static const appName = 'Жемчужины Тарифи';
  static const authorName = 'Шейх \'Абду-ль-\'Азиз ат-Тарифи';

  static const citations = 'Цитаты';
  static const pages = 'Страницы';
  static const bookmarks = 'Избранное';
